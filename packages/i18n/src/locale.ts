...
export const locale: Record<string, LocalizationMap> = {
    ...
    "error.heading": buildLocales("🔴 Something went wrong!", {
        [Locale.Russian]: "🔴 Что-то пошло не так!",
        [Locale.Ukrainian]: "🔴 Щось пішло не так!",
        [Locale.Dutch]: "🔴 Er ging iets mis!",
        [Locale.French]: "🔴 Quelque chose s'est mal passé !",
        [Locale.German]: "🔴 Etwas ist schiefgelaufen!",
        [Locale.Polish]: "🔴 Coś poszło nie tak!",
        [Locale.SpanishES]: "🔴 ¡Algo ha salido mal!",
        [Locale.SpanishLATAM]: "🔴 ¡Algo salió mal!",
        [Locale.PortugueseBR]: "🔴 Algo deu errado!",
        [Locale.Turkish]: "🔴 Bir şeyler ters gitti!",
        [Locale.Italian]: "🔴 Qualcosa è andato storto!",
        [Locale.Indonesian]: "🔴 Ada yang salah!",
        [Locale.Czech]: "🔴 Něco se pokazilo!",
    }),
    ...
    "error.id": buildLocales("**Error ID:** {{interactionId}}", {
        [Locale.Russian]: "**Ошибка:** {{interactionId}}",
        [Locale.Ukrainian]: "**Помилка:** {{interactionId}}",
        [Locale.Dutch]: "**Fout:** {{interactionId}}",
        [Locale.French]: "**Erreur :** {{interactionId}}",
        [Locale.German]: "**Fehler:** {{interactionId}}",
        [Locale.Polish]: "**Błąd:** {{interactionId}}",
        [Locale.SpanishES]: "**Error:** {{interactionId}}",
        [Locale.SpanishLATAM]: "**Error:** {{interactionId}}",
        [Locale.PortugueseBR]: "**Erro:** {{interactionId}}",
        [Locale.Turkish]: "**Hata:** {{interactionId}}",
        [Locale.Italian]: "**Errore:** {{interactionId}}",
        [Locale.Indonesian]: "**Error:** {{interactionId}}",
        [Locale.Czech]: "**Chyba:** {{interactionId}}",
    }),
    ...
    "settings.about.heading": buildLocales("<:jstmemit:1533562196980797462> Hey, I'm Jstmemit", {
        ...
        [Locale.Ukrainian]: "❓ Про цього бота",
