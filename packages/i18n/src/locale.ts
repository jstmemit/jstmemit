...
export const locale: Record<string, LocalizationMap> = {
    ...
    "settings.font.body": buildLocales("Choose the font you'd like to see on memes", {}),
    "settings.font.random.label": buildLocales("Random font", {}),
    "settings.font.random.description": buildLocales("Cycle through all fonts", {}),
    ...
    "settings.font.openDyslexic.description": buildLocales(
        "Font with increased readability for people with dyslexia",
        {},
    ),
