...
export const noragamiYatoNoragamiMoneyFloor1: Template = {
    ...
    element: ({ texts, images, font }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=auto,q=50,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/noragamiYatoNoragamiMoneyFloor1.png"
                width={447}
                height={275}
