...
export const noragamiYatoNoragamiMoneyFloor1: Template = {
    ...
    element: ({ texts, images }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=50,w=800,metadata=none,fit=scale-down,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/noragamiYatoNoragamiMoneyFloor1.png"
                width={447}
                height={275}
