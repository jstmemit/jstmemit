...
export const soGladIGrewUpWithThis: Template = {
    ...
    element: ({ images }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=50,w=800,metadata=none,fit=scale-down,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/soGladIGrewUpWithThis.png"
                width={1313}
                height={790}
