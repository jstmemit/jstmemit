...
export const aotErenYeagerHappyVsDepressed: Template = {
    ...
    element: ({ texts }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=55,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/aotErenYeagerHappyVsDepressed.png"
                width={359}
                height={720}
