...
export const blendsMaikaUhHuh: Template = {
    ...
    displayName: buildLocales("Maika uh-huh", {
        ...
        [Locale.French]: "Maika euh-euh",
        [Locale.German]: "Maika äh-äh",
    ...
    element: ({ texts }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=55,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/blendsMaikaUhHuh.png"
                width={1280}
                height={720}
