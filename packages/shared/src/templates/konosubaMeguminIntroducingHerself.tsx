...
export const konosubaMeguminIntroducingHerself: Template = {
    ...
    element: ({ texts }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=55,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/gifs/konosubaMeguminIntroducingHerself.gif"
                width={500}
                height={283}
