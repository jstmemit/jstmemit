...
export const rtnobgsMaiSakurajimaPhoneReaction: Template = {
    ...
    element: ({ texts }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=50,w=800,metadata=none,fit=scale-down,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/rtnobgsMaiSakurajimaPhoneReaction.png"
                width={200}
                height={400}
