...
export const purestCookie: Template = {
    ...
    element: ({ images }: TemplateProps) => (
        ...
        >
            ...
            />
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=50,w=800,metadata=none,fit=scale-down,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/purestCookie.png"
                width={1067}
                height={591}
