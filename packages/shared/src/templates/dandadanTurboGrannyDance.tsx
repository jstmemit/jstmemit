...
export const dandadanTurboGrannyDance: Template = {
    ...
    element: ({ texts }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=auto,q=50,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/gifs/dandadanTurboGrannyDance.gif"
                width={1280}
                height={720}
