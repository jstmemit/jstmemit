...
export const hucSylphynfordTachibanaWithAGun: Template = {
    ...
    element: ({ texts }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=auto,q=50,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/hucSylphynfordTachibanaWithAGun.png"
                width={437}
                height={447}
