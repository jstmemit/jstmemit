...
export const mrMcMahonReaction: Template = {
    ...
    texts: [
        ...
        { id: 3, description: "fourth reaction", minLength: 1, maxLength: 10 },
    ],
    images: [],
    element: ({ texts, font }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=50,w=800,metadata=none,fit=scale-down,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/mrMcMahonReaction.png"
                width={1000}
                height={1500}
