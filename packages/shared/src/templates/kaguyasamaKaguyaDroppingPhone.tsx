...
export const kaguyasamaKaguyaDroppingPhone: Template = {
    ...
    element: ({ images }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=55,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/kaguyasamaKaguyaDroppingPhone.png"
                width={640}
                height={831}
