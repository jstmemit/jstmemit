...
export const kaguyasamaKaguyaDroppingPhone: Template = {
    ...
    element: ({ images, font }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=auto,q=50,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/kaguyasamaKaguyaDroppingPhone.png"
                width={640}
                height={831}
