...
export const dsNezukoIsBeautiful: Template = {
    ...
    element: ({ texts, images, font }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=50,w=800,metadata=none,fit=scale-down,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/dsNezukoIsBeautiful.png"
                width={1710}
                height={855}
            ...
            <img
                ...
                width={600}
                height={600}
                style={{ position: "absolute", bottom: 105, left: 150, borderRadius: "100%", objectFit: "cover" }}
            />
            <img
                src={images[1]}
                width={400}
                height={400}
                style={{ position: "absolute", bottom: 305, right: 150, borderRadius: "100%", objectFit: "cover" }}
            />
            <div
                style={{
                    position: "absolute",
