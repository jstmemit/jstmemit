...
export const arobmiSistineFibelPointingFinger: Template = {
    ...
    element: ({ texts }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=auto,q=50,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/arobmiSistineFibelPointingFinger.png"
                width={400}
                height={234}
