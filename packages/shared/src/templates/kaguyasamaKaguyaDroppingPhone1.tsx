...
export const kaguyasamaKaguyaDroppingPhone1: Template = {
    ...
    element: ({ images }: TemplateProps) => (
        ...
        >
            ...
            />
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=auto,q=50,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/kaguyasamaKaguyaDroppingPhone1.png"
                width={640}
                height={831}
