...
export const kaguyasamaChikaFujiwaraHappyVsShocked: Template = {
    ...
    element: ({ texts }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=auto,q=50,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/kaguyasamaChikaFujiwaraHappyVsShocked.png"
                width={315}
                height={369}
