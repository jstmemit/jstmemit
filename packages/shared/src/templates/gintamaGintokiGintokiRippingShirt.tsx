...
export const gintamaGintokiGintokiRippingShirt: Template = {
    ...
    element: ({ texts }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=55,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/gifs/gintamaGintokiGintokiRippingShirt.gif"
                width={500}
                height={281}
