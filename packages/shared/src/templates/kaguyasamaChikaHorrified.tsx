...
export const kaguyasamaChikaHorrified: Template = {
    ...
    element: ({ texts, font }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=50,w=800,metadata=none,fit=scale-down,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/gifs/kaguyasamaChikaHorrified.gif"
                width={498}
                height={280}
