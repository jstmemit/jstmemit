...
export const griffinsPeterGriffinRunningAway: Template = {
    ...
    element: ({ texts, images, font }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=auto,q=50,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/griffinsPeterGriffinRunningAway.png"
                width={800}
                height={600}
