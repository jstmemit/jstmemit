...
export const bumperSticker: Template = {
    ...
    element: ({ images }: TemplateProps) => (
        ...
        >
            ...
            />
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=50,w=800,metadata=none,fit=scale-down,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/bumperSticker.png"
                width={814}
                height={691}
