...
export const spongebobRainbow: Template = {
    ...
    element: ({ texts, images, font }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=50,w=800,metadata=none,fit=scale-down,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/spongebobRainbow.jpg"
                width={1920}
                height={1200}
