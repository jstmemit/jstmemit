...
export const toradoraTaigaHoldingLeek1: Template = {
    ...
    element: ({ texts, images, font }: TemplateProps) => (
        ...
        >
            <img
                src="https://wideunits.nl/cdn-cgi/image/f=webp,q=50,w=800,metadata=none,fit=scale-down,onerror=redirect/https://files.wideunits.nl/jstmemit/images/templates/toradoraTaigaHoldingLeek1.png"
                width={519}
                height={290}
